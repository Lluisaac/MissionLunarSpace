...
public class DAOSauvegardeDefautGroupe extends DAO {


    private List<String> classementTemp;
    private ChoixGroupeActivity activity;

    public DAOSauvegardeDefautGroupe(ArrayList<String> liste, ChoixGroupeActivity activity) {
    ...
    protected String[] doInBackground(String... strings) {
        ...
        classementTemp = getAllClassementGroupe(idGroupe);
    ...
    private List<String> getAllClassementGroupe(int idGroupe) {
        try {
